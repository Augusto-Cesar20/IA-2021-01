...
def lista_f6 (lista_dec, pop, xy):
    ...
    for i in lista_dec:
        ...
        if (r_f6 >= melhor and r_f6 <= 1):
            posi = n
            melhor = r_f6

        n = n + 1
    #print("Lista de F6", resp)
    print("MELHOR => Individuo:", pop[posi], " - X =", xy[posi][0], "_ Y = ", xy[posi][1], "- F6 =",  melhor)
...
def main():
    ...
    for geracao in range(4000): #quantidade de gerações
        prob = lista_f6(dec_xy, pop, div_xy) #Lista com a probabilidade de escolha de cada elemento em ordem
